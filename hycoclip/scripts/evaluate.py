...
# python scripts/evaluate.py --config configs/eval_zero_shot_retrieval.py --checkpoint-path checkpoints/hycoclip_vit_b.pth --train-config configs/train_hycoclip_vit_b.py
# python scripts/evaluate.py --config configs/eval_zero_shot_retrieval.py --checkpoint-path checkpoints/meru_vit_b.pth --train-config configs/train_meru_vit_b.py
# python scripts/evaluate.py --config configs/eval_zero_shot_retrieval.py --checkpoint-path checkpoints/clip_vit_b.pth --train-config configs/train_clip_vit_b.py
