...
from MetaCLIP.src.training.distributed import world_info_from_env
from MetaCLIP.src.training.data import DataInfo
from MetaCLIP.src.open_clip.transform import _convert_to_rgb
