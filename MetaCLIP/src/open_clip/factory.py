...
from MetaCLIP.src.open_clip import model as model_zoo
from MetaCLIP.src.open_clip.model import CLIP, convert_weights_to_fp16, resize_pos_embed
from MetaCLIP.src.open_clip.openai import load_openai_model
from MetaCLIP.src.open_clip.pretrained import get_pretrained_url, download_pretrained
from MetaCLIP.src.open_clip.transform import image_transform
from MetaCLIP.src.training.checkpoint import load_checkpoint
...
def create_model(
    ...
    if pretrained.lower() == 'openai':
        ...
        import importlib
        for model_code in os.listdir(f"MetaCLIP/src/open_clip"):
            if not model_code.endswith("model.py"):
                continue
            module_name = "MetaCLIP.src.open_clip." + model_code[:-len(".py")]
